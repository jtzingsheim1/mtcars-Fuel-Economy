...
interaction effects were identified. In the model selection phase the goal was
to identify the model that best predicted fuel economy so that the role of
...
not have a significant impact on fuel economy in this data set. The impact was
quantified, but it is important to note that it is likely due to random chance.
...
[GitHub repo][1] for this project submission.
...
interested the complete EDA portion can be found on the [GitHub repo][1] for
this project submission here. In summary, the unexpected results above are no
longer present once other factors are controlled for. In the final EDA code
chunk a few additional covariations are explored.
