...
these variables are all very much related.
...
Additional covariations were explored, but that code is not shown here. It is
also worth mentioning these two points:

* By definition, displacement = effective cylinder volume * number of cyls
* Quarter mile time is a result of many features of the car similar to mpg, it
should be treated with caution when included in models.
